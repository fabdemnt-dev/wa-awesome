...
const checks = [
  ...
  ['4 staging hostはstaging', () => config.includes("injected.environment === 'staging'") && config.includes('injected.hosts.includes(host)')],
  ...
  ['21 production CORS origin', () => functions.includes("cors: ['https://fabdemnt-dev.github.io']")],
